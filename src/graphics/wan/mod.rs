...
//!
//! This module provides functionality for parsing Pokemon Mystery Dungeon
...
pub mod flags {
    ...
    pub const _ATTR0_Y_OFFSET_MASK: u16 = 0x03FF; // 0000 0011 1111 1111
    ...
    pub const _ATTR1_X_OFFSET_MASK: u16 = 0x01FF; // 0000 0001 1111 1111
    ...
    pub const _ATTR2_TILE_NUM_MASK: u16 = 0x03FF; // 0000 0011 1111 1111

    // ATTR0/1 combined resolution flags
    pub const _ATTR01_RES_MASK: u16 = 0xC000; // 1100 0000 0000 0000
...
impl From<WanError> for io::Error {
    fn from(err: WanError) -> Self {
        match err {
            WanError::Io(io_err) => io_err,
            WanError::InvalidDataStructure(msg) => io::Error::new(io::ErrorKind::InvalidData, msg),
            WanError::OutOfBounds(msg) => {
